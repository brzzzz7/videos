...
import {
  ...
  Trend,
  Wait,
} from "./components/illos/errors";
import { ramp } from "./lib/audio";
import type { Scene } from "./data/errors";
import { hook } from "./data/errors";
import {
  clips,
  ctaFrame,
  cueMark,
...
const Illustration: React.FC<{ scene: Scene; at: (s: number) => number }> = ({
  ...
  switch (scene.kind) {
    ...
    case "wait":
      return <Wait at={at} />;
    case "product":
      return <Product at={at} />;
    case "trend":
      return <Trend at={at} />;
    case "cta":
      return <CtaErrors at={at} />;
  }
};
...
export const ErrorsReel: React.FC = () => {
  return (
